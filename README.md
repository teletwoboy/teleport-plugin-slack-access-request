...
<summary> Access Request </summary>
  ...
  - Requester
    ...
    - Select `Start Date`
      ...
      <img width="512" height="334" alt="Image" src="https://github.com/user-attachments/assets/0a906259-057a-47ce-9d3d-799717ab87c5" />
    
    - Select `Access Duration`

      <img width="512" height="442" alt="Image" src="https://github.com/user-attachments/assets/dbf93076-c6a9-4a5f-981d-6569288990ea" />

    - Select `Request TTL`

      <img width="512" height="543" alt="Image" src="https://github.com/user-attachments/assets/7750f5cb-77dd-4e5f-8800-efa1edc766d2" />
  
    - Review the `summary`, fill in the `request reason`, and click the `Submit` button
      
      <img width="512" height="492" alt="Image" src="https://github.com/user-attachments/assets/fa60711a-b1ff-4c66-a96e-58495ecfc7de" />

    - Check the `request creation message` in the channel

      <img width="489" height="265" alt="Image" src="https://github.com/user-attachments/assets/6823df31-316b-4c1c-8a8b-887fe78cae46" />
  ...
  - Reviewer (in the Reviewers Channel)
    ...
    - See the Access Request notification and click `Review Request` button
      ...
      <img width="486" height="332" alt="Image" src="https://github.com/user-attachments/assets/268101e0-37cf-444d-866f-997d53b1934e" />

    - Fill in the `review reason` and select `Allow` or `Deny`

      <img width="505" height="557" alt="Image" src="https://github.com/user-attachments/assets/155e71b7-7860-4d8a-b2e1-4fa77548697e" />

    - Check the `review result message` in the channel

      <img width="661" height="388" alt="Image" src="https://github.com/user-attachments/assets/87160b8d-e61b-4190-b536-232f3c98ba2a" />
  ...
  - Requester
    ...
    - Check if the request has been reviewed
      ...
      1. APPROVED
         ...
         <img width="669" height="421" alt="Image" src="https://github.com/user-attachments/assets/e859eae1-0f70-496f-859b-cea2d7e57e7a" />

      2. DENIED

         <img width="398" height="173" alt="Image" src="https://github.com/user-attachments/assets/ef0262bf-dd3c-408b-ad24-1d1571e7cbb5" />
