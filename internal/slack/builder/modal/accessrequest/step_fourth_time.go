...
type fourthStepTimeBuilder struct {
	payload *accessrequest.AccessDurationDateSelect
}

func NewFourthStepTimeBuilder(p *accessrequest.AccessDurationDateSelect) modal.Builder {
	return &fourthStepTimeBuilder{
		payload: p,
	}
}

func (f *fourthStepTimeBuilder) Build() (*slack.ModalViewRequest, error) {
...
func (f *fourthStepTimeBuilder) BuildBlocks() slack.Blocks {
...
func (f *fourthStepTimeBuilder) BuildStartDateBlock() []slack.Block {
...
func (f *fourthStepTimeBuilder) BuildAccessDurationBlock() []slack.Block {
...
func (f *fourthStepTimeBuilder) BuildPrivateMetadata() (string, error) {
	privateMetadata := &accessrequest.AccessDurationTimeSelectPrivateMetadataPayload{
		...
		SelectedAccessDurationDate:       f.payload.AccessDurationDate,
	}
