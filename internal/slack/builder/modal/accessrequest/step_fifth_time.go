...
type fifthStepTimeBuilder struct {
	payload *accessrequest.RequestTTLDateSelect
}

func NewFifthStepTimeBuilder(p *accessrequest.RequestTTLDateSelect) modal.Builder {
	return &fifthStepTimeBuilder{
		payload: p,
	}
}

func (f *fifthStepTimeBuilder) Build() (*slack.ModalViewRequest, error) {
...
func (f *fifthStepTimeBuilder) BuildBlocks() slack.Blocks {
...
func (f *fifthStepTimeBuilder) BuildStartDateBlock() []slack.Block {
...
func (f *fifthStepTimeBuilder) BuildAccessDurationBlock() []slack.Block {
...
func (f *fifthStepTimeBuilder) BuildRequestTTLBlock() []slack.Block {
	text := BuildRequestTTLSecondOptInfoText(f.payload.SelectedRequestTTLOptionName, f.payload.RequestTTL)
	...
	requestTTLDateTimeBlock := slack.NewActionBlock(
		...
		slack.NewTimePickerBlockElement(util.ARequestRequestTTLTimeBlockActionID),
	)
	return []slack.Block{requestTTLOptInfoBlock, requestTTLDateTimeBlock}
}

func (f *fifthStepTimeBuilder) BuildPrivateMetadata() (string, error) {
	privateMetadata := &accessrequest.RequestTTLTimeSelectPrivateMetadataPayload{
		...
		SelectedRequestTTLOptionID:       f.payload.SelectedRequestTTLOptionID,
		SelectedRequestTTLOptionName:     f.payload.SelectedRequestTTLOptionName,
		SelectedRequestTTLDate:           f.payload.RequestTTLDate,
	}
